      ...
      >
        ...
        <div className="space-y-3">
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-5 py-3 rounded-2xl bg-white text-zinc-900 font-bold text-sm hover:bg-zinc-100 transition-colors border-none cursor-pointer"
          >
